...
<legend> Groups created</legend>
<table>
<?php

$query = mysql_query("SELECT * FROM creategroup WHERE groupadminID='$lrn'") or die("ERROR QUERY");
while($rows = mysql_fetch_array($query)){
	$_SESSION["groupname"] = $rows[1];
	$id = $rows[0];
	echo "<tr><td style=\"padding-right:15px;\"><a href=\"addgrouppost.php?ID=$id\" style='text-decoration: none;'>" . $rows[1] . "</a></td><td>" . "<a href=\"addgroupmembers.php?ID=$id\" class=\"btn btn-default\" name=\"btnADD\"><span class=\"icon-plus\" aria-hidden=\"true\"></span>ADD</a></td> 
	<td> <a href=\"addgrouppost.php?ID=$id\" class=\"btn btn-default\" name=\"btnVIEW\"><span class=\"icon-pencil\" aria-hidden=\"true\"></span>VIEW</a></td> 
	<td><a href=\"delete_group.php?ID=$id\" class=\"btn btn-default\" name=\"btnDELETE\"><span class=\"icon-trash\" aria-hidden=\"true\"></span> DELETE </td></a></tr>";			
}
?>			
</table>
