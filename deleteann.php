...
$queryDeletepost = mysql_query("DELETE FROM announcement WHERE ID='$postID'");
$queryDeletecomment = mysql_query("DELETE FROM comment_announcement WHERE annID='$postID'");
?>
<script>
	swal({
    title: "Confirmation",
...
echo("<script>location.href='announcement.php';</script>");
}
if(!isset($_POST["btnYes"])){
?>
