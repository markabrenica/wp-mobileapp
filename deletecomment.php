...
$query = mysql_query("DELETE FROM reply WHERE commentID='$replyID'") or die("ERROR QUERY");
?>
<script>
	var num = "";
  ...
  function(isConfirm){
    if (isConfirm){
    	location.href = 'viewreply.php?ID=' + document.getElementById("ID").innerHTML;
    }
  });
...
echo("<script>location.href='viewreply.php?ID=$postIDnum';</script>");
}
if(!isset($_POST["btnYes"])){
?>
