...
$queryDeletepost = mysql_query("DELETE FROM grouppost WHERE ID='$postID'");
$queryDeletecomment = mysql_query("DELETE FROM commentgroup WHERE postID='$postID'");
?>
<script>
	var num = "";
...
echo("<script>location.href='addgrouppost.php?ID=$id';</script>");
}
if(!isset($_POST["btnYes"])){
?>
