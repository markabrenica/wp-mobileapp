...
<li role="presentation" class="w3-small"><a href="message.php" style="color:#66757f;"><span class="fa fa-envelope" aria-hidden="true"></span></a></li>
	...
	<div class="se-pre-con"></div>
		<legend>Photos <small> Mobile Uploads</small> <h5><a href="profilepic.php" style="text-decoration:none;">Profile Pictures</a> | <a href="pictures.php" style="text-decoration:none;">Mobile Uploads</a></h5></legend>
		<div class="container">
		<div class="row" id="gallery">
			<div class="col-lg-3 col-md-4 col-xs-6 thumb">
				<?php
					$query = mysql_query("SELECT imgpath, dateuploaded, timeuploaded, userLRN, ID FROM picgallery WHERE userLRN='$lrn' ORDER BY dateuploaded DESC, timeuploaded DESC") or DIE("ERROR IN QUERY");
				...
				<?php
					...
					while($rows = mysql_fetch_array($query)){
						...
						$id = $rows["ID"];
				?>
                <a class="thumbnail" href="viewpic.php?ID=<?php echo $id; ?>">
