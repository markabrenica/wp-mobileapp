...
if(isset($_POST["save"])){
	...
	$query = mysql_query("UPDATE post SET content='$content' WHERE ID='$postID'");
	?>
<script> 
	swal({
    title: "Success",
...
if(!isset($_POST["save"])){
$query= mysql_query("SELECT ID, content, dateposted, timeposted, post.userLRN, Fname, Lname FROM post INNER JOIN profile ON post.userLRN = profile.userLRN WHERE post.ID='$postID'");
