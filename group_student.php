...
<body>
	<div class="container">
	<form method="POST" action="group_student.php">
...
<legend>Joined Groups</legend>
<table class="table">
<?php
$query = mysql_query("SELECT groupID, userID, groupname FROM creategroup INNER JOIN groupmember ON creategroup.ID=groupmember.groupID WHERE userID='$lrn' GROUP BY groupID") or die("ERROR QUERY");
while($rows = mysql_fetch_array($query)){
	$_SESSION["groupname"] = $rows[1];
	$id = $rows[0];
	echo "<tr>
	<td style=\"padding-right:15px;\"><a href=\"addgrouppost.php?ID=$id\" style='text-decoration: none; font-size: 15px;'>" . $rows[2] . "</a></td><td>" . "<a href=\"addgroupmembers.php?ID=$id\" class=\"btn btn-default\" name=\"btnADD\"><span class=\"icon-plus\" aria-hidden=\"true\"></span></a></td> 
	<td> <a href=\"addgrouppost.php?ID=$id\" class=\"btn btn-default\" name=\"btnVIEW\" style='text-decoration: none;'><span class=\"icon-pencil\" aria-hidden=\"true\"></span></a></td> 
	<td><a href=\"addgrouppost.php?ID=$id\" class=\"btn btn-default\" name=\"btnDELETE\" style='text-decoration: none;'><span class=\"icon-trash\" aria-hidden=\"true\"></span></td></a></tr>";			
}
?>			
</table>
