...
if(isset($_POST["save"])){
	...
	$query = mysql_query("UPDATE announcement SET content='$content' WHERE ID='$postID'");
	?>
<script>
	swal({
    title: "Confirmation",
...
if(!isset($_POST["save"])){
$query= mysql_query("SELECT ID, content, dateposted, timeposted, announcement.userLRN, Fname, Lname FROM announcement INNER JOIN profile ON announcement.userLRN = profile.userLRN WHERE announcement.ID='$postID'");
