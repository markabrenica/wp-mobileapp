                        ...
                        <ul class="nav pull-right">
                            <li class="dropdown">
								...
								<li>
									...
									<li>
                                        <a tabindex="-1" href="page_ADMIN.html">Go back to Home</a>
                                    </li>
                                    <li>
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li class="active">
                            <a class="left-gap" href="dsearch.php"><i class="icon-chevron-right"></i> Search</a>
                        </li>
						<li>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="block">
								...
								<input type="submit" class="btn btn-info" name="buttonSearch" value="Search">
...
echo "</table></div>
 ...
 <a href=\"dsearch.php\" class=\"btn btn-danger\">Close</a></form>
 </div>
 </div>
 </div>
</div>";
