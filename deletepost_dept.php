...
$queryDeletepost = mysql_query("DELETE FROM department WHERE ID='$postID'");
$queryDeletecomment = mysql_query("DELETE FROM comment_dept WHERE postID='$postID'");
$queryDeletereply = mysql_query("DELETE FROM reply_dept WHERE commentID='$postID'");
?>
<script> 
	swal({
    title: "Confirmation",
