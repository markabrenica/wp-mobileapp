...
$queryDeletegroup = mysql_query("DELETE FROM creategroup WHERE ID='$id'");
$queryDeletecomment = mysql_query("DELETE FROM groupmember WHERE groupID='$id'");
?>
<script>
	swal({
    title: "Confirmation",
...
<h4> Are you sure you want to delete your group? </h4>
